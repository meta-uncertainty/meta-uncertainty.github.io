...
engine: knitr
poster:
  pdf: "../images/meta_uncertainty_poster_aistats.pdf"
---
...
<a href="https://proceedings.mlr.press/v206/schmitt23a.html" target="_blank" class="btn btn-outline-dark" role="button">Read the AISTATS 2023 paper</a>
:::
...
:::{.g-col-12 .g-col-md-8 .d-flex .flex-column .align-items-center .video-block}
...
:::{.g-col-12 .g-col-md-4 .d-flex .flex-column}

```{=html}
<img src="/images/meta_uncertainty_poster_aistats.png" style="width: 100%; object-fit: contain" onclick="window.open('/images/meta_uncertainty_poster_aistats.pdf', 'blank');"/>
```
:::
